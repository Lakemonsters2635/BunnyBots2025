  ...
  public void periodic() {
    ...
    if (followJoystics) {
      ...
      // } else {
        ...
        this.drive(xPowerCommanded * DrivetrainSubsystem.kMaxSpeed * 0, 
                yPowerCommanded * DrivetrainSubsystem.kMaxSpeed * 0,
                MathUtil.applyDeadband(rotCommanded * this.kMaxAngularSpeed * 0, 0.2),
                true);
      // }
    }
